      ...
      <div className="m-[0_0_40px_0] flex flex-col items-center box-sizing-border">
        <div className="bg-[#414084] relative m-[0_0_40px_0] flex p-[34px_40px_25px_50px] w-[1590px] box-sizing-border">
          ...
          <div className="relative flex flex-row justify-between w-[1500px] h-[fit-content] box-sizing-border">
            <div className="rounded-[40px] border-[1px_solid_#CEDEBD] bg-[#8579B2] flex flex-row justify-between p-[9px_9px_9px_39px] w-[495px] box-sizing-border">
              ...
              <div className="flex flex-row box-sizing-border">
                <div className="m-[15px_40.3px_15px_0] flex box-sizing-border">
                  <span className="break-words font-['Poppins'] font-medium text-[13px] leading-[1] text-[#FFFFFF]">
                  General Mode
                  </span>
                </div>
                <div className="rounded-[40px] bg-[#CEDEBD] flex p-[15px_0.4px_15px_0] w-[138px] box-sizing-border">
