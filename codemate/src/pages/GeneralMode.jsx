...
export default function GeneralMode() {
  ...
  const handleLogin = () => {
    ...
    // Navigate to GeneralMode after successful login
  ...
  return (
    ...
    >
      ...
      {/* Render Login component if login form is visible */}
      <div
      ...
      >
        ...
        >
          ...
          <div className="rounded-[50px] bg-[#49625b] relative mb-4 p-2 w-full text-center cursor-pointer transition duration-300 hover:bg-[#555]">
            <span
