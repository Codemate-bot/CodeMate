export default function IndividualMode() {
  return (
    <div className="bg-[#FAF1E4] flex flex-row w-[1920px] box-sizing-border">
      <div className="bg-[#8579B2] relative flex flex-col p-[52px_0_40px_0] w-[330px] box-sizing-border">
        <div className="bg-[#8579B2] absolute left-[0px] top-[0px] right-[0px] bottom-[0px] h-[100%]">
        </div>
        <div className="relative m-[0_88.4px_40px_0] flex self-center box-sizing-border">
          <span className="relative break-words font-['Poppins'] font-bold text-[26px] leading-[1] text-[#FFFFFF]">
          Code Mate
          </span>
        ...
        <div className="rounded-[40px] bg-[#414084] relative m-[0_24px_844px_24px] flex self-start p-[23px_85.1px_22px_0] w-[244px] box-sizing-border">
          ...
          <span className="absolute left-[56px] top-[50%] translate-y-[-50%] break-words font-['Poppins'] font-normal text-[15px] leading-[1] text-[#FFFFFF]">
      ...
      <div className="m-[0_0_40px_0] flex flex-col items-center box-sizing-border">
        <div className="bg-[#414084] relative m-[0_0_40px_0] flex p-[34px_40px_25px_50px] w-[1590px] box-sizing-border">
          <div className="bg-[#414084] absolute left-[0px] top-[0px] right-[0px] bottom-[0px] h-[100%]">
          </div>
          <div className="relative flex flex-row justify-between w-[1500px] h-[fit-content] box-sizing-border">
            <div className="rounded-[40px] border-[1px_solid_#CEDEBD] bg-[#8579B2] relative flex p-[9px_39.4px_9px_9px] w-[495px] box-sizing-border">
              <div className="relative flex flex-row justify-between w-[444.6px] h-[fit-content] box-sizing-border">
                <div className="flex flex-row box-sizing-border">
                  <div className="rounded-[40px] bg-[#CEDEBD] m-[0_40px_0_0] flex p-[15px_0.5px_15px_0] w-[165px] box-sizing-border">
              ...
              <div className="rounded-[40px] border-[1px_solid_#CEDEBD] bg-[#8579B2] absolute left-[50%] bottom-[0px] translate-x-[-50%] flex flex-row justify-between p-[9px_39.4px_9px_9px] w-[495px] box-sizing-border">
                <div className="flex flex-row box-sizing-border">
                  <div className="rounded-[40px] bg-[#CEDEBD] m-[0_40px_0_0] flex p-[15px_0.5px_15px_0] w-[165px] box-sizing-border">
                    <span className="break-words font-['Poppins'] font-medium text-[13px] leading-[1] text-[#414084]">
                    Individual Mode
            ...
            <div className="m-[6px_0_15px_0] flex flex-row w-[109px] h-[fit-content] box-sizing-border">
          ...
          <div className="relative m-[683px_39px_10px_0] flex box-sizing-border">
            <div className="relative flex flex-col box-sizing-border">
              <div className="m-[0_0_29px_0] flex flex-row gap-[0_29px] w-[fit-content] box-sizing-border">
                ...
                <div className="rounded-[10px] border-[1px_solid_#BA9359] flex flex-col p-[15px_0_15px_19px] w-[315px] box-sizing-border">
                  <div className="m-[0_0_5px_0] inline-block self-start break-words font-['Plus_Jakarta_Sans'] font-semibold text-[14px] leading-[1.143] text-[#8579B2]">
